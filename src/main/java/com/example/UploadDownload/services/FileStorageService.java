...
public class FileStorageService {
    //prendo il valore dinamicamente dalla variabile inserita nello yml
    @Value("${fileDirectory}")
    ...
    public byte[] download(String fileName, HttpServletResponse response) throws IOException {
        ...
        //effettuiamo un controllo sull'estensione per dare alla response il tipo corretto questa è una casistica sulle immagini
        switch (extension) {
            case "jpg", "jpeg":
